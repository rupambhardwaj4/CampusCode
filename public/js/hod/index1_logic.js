...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function addToBookmarkedTab(problemRow) {
        ...
        const emptyRow = bookmarkedTable.querySelector('tr td[colspan="4"]');
        ...
        clonedRow.dataset.viewUrl = `/college/hod/view-problem/${problemId}`;
        ...
        clonedRow.innerHTML = `
            <td class="px-6 py-4">
                ...
                <div class="text-xs text-gray-500 dark:text-gray-400">${subject || 'N/A'}</div>
            </td>
            <td class="px-6 py-4">
                <span class="${difficultyClass}">${difficulty}</span>
            </td>
            <td class="px-6 py-4 text-xs text-gray-500 dark:text-gray-400">${tags || 'N/A'}</td>
        ...
        if (bookmarkedRow) {
            ...
            setTimeout(() => {
                ...
                if (!bookmarkedTable.querySelector('tr[data-problem-id]')) {
                    bookmarkedTable.innerHTML = '<tr><td colspan="4" class="py-8 text-center text-gray-500 dark:text-gray-400">No bookmarked problems.</td></tr>';
                }
            }, 300);
        }
    }
